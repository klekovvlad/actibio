            ...
            button.onclick = () => {
                ...
                if(this.live > 0 && this.page < this.questions.length + 1) {
                    ...
                    if(this.live === 0) {
                        ...
                        this.message = `LOOSER ${this.brand}: ${(this.page - 1) + (this.live - 1)} из ${this.questions.length}`
                    }else{
                        this.renderResultPage('winner')
                        this.message = `WINNER ${this.brand}: ${this.questions.length + (this.live - 1)} из ${this.questions.length}`
                    }
